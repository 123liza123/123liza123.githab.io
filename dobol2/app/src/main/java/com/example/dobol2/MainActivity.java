...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnTouchListener listener = new View.OnTouchListener() {
        @Override
        public boolean onTouch(View view, @NonNull MotionEvent motionEvent) { // в motionEvent пишутся координаты
            ...
            switch (motionEvent.getAction()) { // метод getAction() считывает состояние касания (нажатие/движение/отпускание)
                ...
                case MotionEvent.ACTION_MOVE: // движение
                    ...
                    if (x < (xCat + deltaCat) && x > (xCat - deltaCat) && y < (yCat + deltaCat) && y > (yCat - deltaCat)) { // если пользователь коснулся места нахождения кота
                        ...
                        toast.setGravity(Gravity.NO_GRAVITY, (int) x - (int) xCat, (int) y - (int) yCat);
            ...
            // вывод на экранв три строки считанных значений координат
